...
window.setAttr = function (e, a) {
  Object.keys(a).forEach(function (key) {
    return e.setAttribute(key, a[key]);
  });
};
...
window.toscroll = function ($e) {
  var $leftElement = $e.offsetLeft + $e.offsetWidth;
  var $leftParentElement = $e.parentNode.offsetLeft + $e.parentNode.offsetWidth - $e.parentNode.offsetWidth + $e.offsetWidth;
